...
set "text=Hello your device is infected with Explorer Destroyer.exe, hit any key to proceed"
echo speech.speak "%text%" >> "speech.vbs"
start speech.vbs
:2
echo Hello your device is infected with ExplorerDestroyer.exe
